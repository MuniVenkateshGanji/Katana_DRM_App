...
public class EventList1 extends ArrayAdapter<EventOneSchema> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        listViewItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, EventDescription1.class);
                intent.putExtra("EventId", List_of_Events.eventMap.get(eventOneSchema) );
