...
public class essential extends AppCompatActivity{
    private String insertDoctorsUrl = "https://unblenched-shoes.000webhostapp.com/essentialpass.php";
    TextView one,status;
    private EditText name, email, phone, Regd, Licence, organisation, address;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.essentialpass);
        ...
        findViewById(R.id.sign_up).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!name.equals("") && !email.equals("") && !phone.equals("")  && !degree.equals("") && !latitude.equals("") && !longitude.equals("") && !address.equals("")) {
                    ...
                    Toast.makeText(essential.this,"You will an Mail in 3 days",Toast.LENGTH_SHORT).show();


                } else
                    Toast.makeText(essential.this, "Please input every field", Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        StringRequest request = new StringRequest(Request.Method.POST, insertDoctorsUrl, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    AlertDialog.Builder build = new AlertDialog.Builder(essential.this);
