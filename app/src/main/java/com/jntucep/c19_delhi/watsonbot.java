...
public class watsonbot extends AppCompatActivity {
  ...
  private static String TAG = "watsonbot";
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    private void recordMessage() {
        if (!listening) {
            ...
            listening = true;
            Toast.makeText(watsonbot.this, "Listening....Click to Stop", Toast.LENGTH_LONG).show();

        } else {
            try {
                microphoneHelper.closeInputStream();
                listening = false;
                Toast.makeText(watsonbot.this, "Stopped Listening....Click to Start", Toast.LENGTH_LONG).show();
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    private void showError(final Exception e) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(watsonbot.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                e.printStackTrace();
            }
        });
    }
