...
public class Profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pro =(CircleImageView) findViewById(R.id.profileDP);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@androidx.annotation.NonNull @NonNull DataSnapshot dataSnapshot) {
                ...
                phno1 = Objects.requireNonNull(dataSnapshot.child("phone").getValue()).toString();
...
*/
    ...
    public void onBackPressed() {
        startActivity(new Intent(Profile.this,MainActivityvolunteer.class));
    }
}
